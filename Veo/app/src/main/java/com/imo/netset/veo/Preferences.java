...
TextView text_done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_done=(TextView)findViewById(R.id.Done_text);
        privacy=(Button)findViewById(R.id.Privacy_button);
        service=(Button)findViewById(R.id.term_service);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.Privacy_button:
                Intent intent_privacy= new Intent(Preferences.this,Privacy_Policy.class);
            ...
            case R.id.term_service:
                ...
                Intent intent_service= new Intent(Preferences.this,Terms_of_Service.class);
